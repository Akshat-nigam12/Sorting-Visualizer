...
import random
from sortingalgo import bubble_sort
...
Button(options_frame, text="Start Sorting", command=sorting, bg='yellow',height=5).grid(row=0, column=3, padx=5, pady=5)
...
Button(options_frame, text="Current Array", command=Generate_array, bg='orange',height=5).grid(row=1, column=3, padx=10, pady=10)
